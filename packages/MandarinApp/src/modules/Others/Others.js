    ...
    const BookingView = () => (
        <View>
            ...
            <View style={styles.infoView}>
                <Text style={styles.txtInfoTitle}>Date: </Text>
            ...
            <View style={styles.infoView}>
                <Text style={styles.txtInfoTitle}>Room: </Text>
                <Text style={styles.txtInfo}>{`${app.userInfo?.booking?.rooms}`}</Text>
            </View>
            <View style={styles.infoView}>
                <Text style={styles.txtInfoTitle}>People: </Text>
    ...
    return (
        <View style={styles.container}>
            <View style={styles.content}>
                ...
                <View style={styles.infoView}>
                    <Text style={styles.txtInfoTitle}>Name: </Text>
                    <Text style={styles.txtInfo}>{app.userInfo?.firstName + ' ' + app.userInfo?.lastName}</Text>
                </View>
                <View style={styles.infoView}>
                    <Text style={styles.txtInfoTitle}>Phone: </Text>
